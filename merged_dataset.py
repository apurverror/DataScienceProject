...
# Read Files
print("Reading 1 ...")
PATH = r'C:\tithi\Term 2'

df = pd.read_csv(os.path.join(PATH, 'merge_dataset.csv'), dtype={'id': str})
df['datetime'] = pd.to_datetime(df['datetime'].apply(lambda x: x * (10 ** 9)))

print("Reading 2 ...")
survey_path = 'C:\\tithi\\Term 2\\Data science and decision making\\surveyResults.xlsx'
